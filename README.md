...
Live demo: inventory-management-system-henna-xi.vercel.app API docs (Swagger): inventory-management-system-lgz8.onrender.com/api/docs/
...
VITE_API_BASE_URL — base URL of the Django backend (e.g. http://127.0.0.1:8000 locally, or the Render URL in production)
Deployment
...
Author
Praveen Kumar GitHub: @PraveenKumar2919
